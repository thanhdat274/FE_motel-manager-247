          ...
          <div className="col-span-2">
            <div className=" bg-white mr-10  ml-10 p-5">
              <div>
                ...
                <p>
                  Được ra đời dựa vào nhu cầu thực tế của các cá nhân, tổ chức cho thuê nhà, phòng trọ, chung cư mini.
                  Ứng dụng quản lý phòng trọ được phát triển giúp cho người quản lý tính toán chính xác tiền phòng, dịch
                  vụ, tiết kiệm thời gian ghi chép, thống kê. <br />
                  Phần mềm quản lý được nhà trọ có nhiều nhà/ khu vực, nhiều phòng. Thiết lập linh động đơn giá dịch vụ,
                  linh động về kỳ thu tiền. <br /> Phần mềm được phát triển trên nền tảng web, sử dụng online, có thể
                  truy cập bất kỳ nơi nào có internet, không phụ thuộc thiết bị, hệ điều hành.
                </p>
                <strong>Các tính năng cơ bản:</strong>
                <p>
            ...
            <div className="mt-10 bg-white mr-10  ml-10 p-5 ">
              ...
              <div className="text-center">
                ...
                <div className=" lg:h-[431px]  sm:h-[330px]  h-[200px] relative text-center  ">
                  <Image src="/images/project-featured.png" alt="logo" layout="fill" priority />
                </div>
              </div>
              <div className="pb-10">
                <p className="pt-3">
                  Tại màn hình chính bạn có thể xem nhanh được tình trạng các phòng. Đăng ký khách thuê mới, xem lại
                  thông tin khách thuê, thực hiện thao tác trả phòng.
                </p>
              </div>
              ...
              <div className="">
                <div className=" md:grid grid-cols-3 pt-10">
                  ...
                  <div className="col-span-2">
                    ...
                    <p>
                      {' '}
                      Khách thuê mới, bạn chỉ cần nhập vài thông tin cơ bản như họ tên, điện thoại, địa chỉ,..., nhập
                      đơn giá phòng, chọn dịch vụ sử dụng, thế là xong. Hoặc nếu cần quản lý chi tiết, bạn có thể nhập
                      đầy đủ thông tin các thành viên thuê trong phòng để tiện kiểm tra về sau.
                    </p>
                  </div>
                </div>
                <div className=" md:grid grid-cols-3 pt-10">
              ...
              <div>
                ...
                <div>
                  ...
                  <p>
                    ...
                    <br />
                    Sử dụng vĩnh viễn: Thanh toán 1 lần 5 năm sẽ được sử dụng phần mềm vĩnh viễn (không tính giảm 10%
                    cho mỗi năm) <br />
                    ...
                    <span className="text-blue-600">
                      Đơn giá trên không bao gồm hướng dẫn và hỗ trợ sử dụng phần mềm trực tiếp tại khách hàng, chúng
                      tôi chỉ hỗ trợ sử dụng trực tuyến qua điện thoại, zalo, skype, ... Nếu quý khách có nhu cầu hỗ
                      trợ, tư vấn trực tiếp chúng tôi sẽ báo chi phí riêng.
                    </span>{' '}
                    <br />
                    Chính sách ưu đãi/ hoa hồng giới thiệu: Miễn phí 2 tháng sử dụng phần mềm hoặc được hưởng hoa hồng 2
                    tháng khi tiếp thị liên kết (Khách hàng A đang sử dụng phần mềm giới thiệu khách hàng B) Tích hợp
                    gửi tin nhắn SMS: Mua gói tin tối thiểu 3,000,000 VND. Mỗi tin nhắn gửi đi có đơn giá là 660 đồng
                    (áp dụng cho tất cả nhà mạng) được trừ dần vào gói tin cho đến khi hết số tiền đã nạp.
                  </p>
                  <p className="pt-5">
            ...
            <div className="mt-10 bg-white mr-10  ml-10 p-5 ">
              ...
              <div className="mt-5">
                ...
                <p>
                  Chúng tôi luôn cố gắng phát triển các tính năng mới đáp ứng nhu cầu đa dạng của khách hàng, mọi nâng
                  cấp chung chúng tôi sẽ cung cấp miễn phí đến khách hàng trong quá trình sử dụng.
                </p>
                <p className="pt-3">
            ...
            <div className="mt-10 bg-white mr-10  ml-10 p-5 ">
              ...
              <p className="pt-3">
                2. Nếu bước một đã hoàn tất và bạn có nhu cầu mua sử dụng, vui lòng chuyển khoản phí tương ứng với gói
                phù hợp vào tài khoản nêu trên trong nội dung thanh toán ghi lại email đăng ký tài khoản.
              </p>
              <p className="pt-3">
            ...
            <div className="mt-10 bg-white mr-10  ml-10 p-5 ">
              ...
              <p className="pt-3">
                - Quản lý dịch vụ, đơn giá, số lượng sử dụng (ví dụ điện, nước, internet, vệ sinh, tiền gửi xe.. linh
                động bổ sung tùy từng khách hàng)
              </p>
              <p className="pt-3">
                - Thêm khách, sửa thông tin khách, trả phòng, quản lý thông tin hợp đồng, xuất, in hợp đồng, tùy chỉnh
                mẫu hợp đồng theo từng nhu cầu khác nhau; quản lý thành viên trong phòng
              </p>
          ...
          <div>
            <div>
              <div className="bg-white mr-10 p-5 ml-10 lg:ml-0 mt-10 lg:mt-0 ">
                ...
                <h1 className="text-2xl font-bold pt-6 pb-5">47+ tỉnh thành/ phố</h1>
              </div>
            </div>
            <div className="mt-10">
              <div className="bg-white mr-10 p-5 ml-10 lg:ml-0 mt-10 lg:mt-0 ">
