                ...
                return (
                  ...
                  >
                    <Link href={`/manager/landlord/${id}/${menu.url}`}>
                      <a
                        className={
                          'h-[45px] text-xs font-bold flex items-center gap-4 text-black px-4 py-3 bg-gradient-to-tr from-light-blue-500 to-light-blue-700 rounded-lg focus:text-white hover:text-white shadow-md'
                        }
                      >
                        {menu.icon}
                        {menu.title}
