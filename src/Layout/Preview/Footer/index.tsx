...
const FooterPreview = (props: Props) => {
  return (
      ...
      {/* <div className="px-6 pt-6 text-black">
          ...
          <form>
            <div className="grid md:grid-cols-3 gird-cols-1 gap-4 flex justify-center items-center">
              <div className="md:ml-auto md:mb-6">
                <p>
                  <strong>Hửi email ngay để được đăng ký và tư vấn sử dụng website</strong>
                </p>
              </div>
        ...
        " id="exampleFormControlInput1" placeholder="Email address" />
              ...
              <div className="md:mr-auto mb-6">
                <button type="submit" className="inline-block px-6 py-2 border-2 bg-blue-500 border-white text-black font-medium text-xs leading-tight uppercase rounded hover:bg-blue-800 focus:outline-none focus:ring-0 transition duration-150 ease-in-out">
                  Gửi
                </button>
              </div>
            </div>
    ...
    ">
            ...
            <p>
              Quản lý phòng trọ chưa bao giờ dễ đến thế.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="flex items-center justify-center md:justify-start mb-4">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="w-4" viewBox="0 0 16 16">
                <path d="M.05 3.555A2 2 0 0 1 2 2h12a2 2 0 0 1 1.95 1.555L8 8.414.05 3.555ZM0 4.697v7.104l5.803-3.558L0 4.697ZM6.761 8.83l-6.57 4.027A2 2 0 0 0 2 14h12a2 2 0 0 0 1.808-1.144l-6.57-4.027L8 9.586l-1.239-.757Zm3.436-.586L16 11.801V4.697l-5.803 3.546Z" />
              </svg>
              <span className='ml-4'>quanlyphongtro247@gmail.com</span>
            </p>
            <p className="flex items-center justify-center md:justify-start mb-4">
      ...
      <div className="text-center text-gray-700 bg-blue-500 p-4">
        © 2022
        <a className="text-gray-800" href=""><strong> Quản lý phòng trọ 24/7</strong></a>
      </div>
    </div>
